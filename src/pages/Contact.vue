<template>
  <div>
    <div class="container">
      <h1
        class="text-center text-primary text-[50px] leading-[64px] font-bold pt-52"
      >
        Contact Us
      </h1>
      <p
        class="text-center text-primary text-[18px] leading-[28px] font-bold w-[42%] mx-auto mt-6 mb-14"
      >
