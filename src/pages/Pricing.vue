<template>
  <div>
    <div class="container">
      ...
      <!-- Three Grid  -->
      <div class="grid md:grid-cols-3 grid-cols-1 gap-10 mb-28">
        <template v-for="item in pricingElems" :key="item.id">
          <Pricing1 :item="item" />
        </template>
      </div>
...
const pricingElems = [
  {
    ...
    type: "Per Design",
    header: "Landing Page",
    content: "When you’re ready to go beyond prototyping in Figma, ",
    arr1: [
      {
        id: 1,
        img: "Pointer.png",
